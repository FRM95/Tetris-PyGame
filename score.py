...
class Score(CustomSurface):
    ...
    def displayScore(self, score:int, color:tuple = (255,255,255), background_color = None, size:int = 20):
        font_text = font.Font('freesansbold.ttf', size)
    ...
    def displayLevel(self, level:int, color:tuple = (255,255,255), background_color = None, size:int = 20):
        font_text = font.Font('freesansbold.ttf', size)
